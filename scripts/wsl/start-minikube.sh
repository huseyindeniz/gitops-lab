# Start Minikube with 2 nodes, 2 CPUs, and 2GB of memory and gpu enabled in the "wsl-cluster" profile
minikube start --nodes 2 --cpus 2 --memory 2048 --gpus all -p wsl-cluster
