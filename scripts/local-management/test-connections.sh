...
declare -A cluster_data=(
  ["local-management"]="58001 $HOME/terraform/certs/local-management.pem"
  ["local-staging"]="58002 $HOME/terraform/certs/local-staging.pem"
  ["local-production"]="58003 $HOME/terraform/certs/local-production.pem"
)
